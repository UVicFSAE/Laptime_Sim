...
class VehicleSweepLimits:
    ...
    spring_f_npm = [UnitConversion.lbpin_to_npm(250), UnitConversion.lbpin_to_npm(550)]
    spring_r_npm = [UnitConversion.lbpin_to_npm(250), UnitConversion.lbpin_to_npm(550)]
